...
export default {
  ...
  methods: {
    getmyexpense(page=1) {
      this.$store.dispatch('admin/AdminController',{'data':{},'method':'get','api':'admin_get_salary','variable':'expense','params':'?page='+page}, { root: true }).then(() => {
