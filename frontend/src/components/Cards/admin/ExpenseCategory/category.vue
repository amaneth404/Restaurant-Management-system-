...
export default {
  ...
  methods: {
    ...
    FilterCategory(){
       this.$store.dispatch('admin/AdminController',{'data':{search:this.form.search},'method':'post','api':'admin_search_category_expense','variable':'category'}, { root: true }).then(() => {
    ...
    deletecategory(id,index) {
      window.Swal.fire({
            ...
            if (result.value) {
              this.$store.dispatch('admin/AdminController',{'data':{},'method':'delete','api':'admin_delete_category_expense','variable':'status','params':id}, { root: true }).then(() => {
         window.Toast.fire({
            icon: "success",
    ...
    update() {
     var form =window.VFToFD(this.category);
      ...
      this.$store
        .dispatch('admin/AdminController',{'data':form,'method':'post','api':'admin_update_category_expense','variable':'category'}, { root: true })
        .then(() => {
    ...
    create() {
      var form =window.VFToFD(this.category);
      this.$store.dispatch('admin/AdminController',{'data':form,'method':'post','api':'admin_create_category_expense','variable':'category'}, { root: true }).then(() => {
